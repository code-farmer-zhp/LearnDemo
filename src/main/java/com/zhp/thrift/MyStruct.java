...
public class MyStruct implements org.apache.thrift.TBase<MyStruct, MyStruct._Fields>, java.io.Serializable, Cloneable, Comparable<MyStruct> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new MyStructStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new MyStructTupleSchemeFactory();
  ...
  public java.util.List<Integer> mylist; // required
  public java.util.Set<Integer> myset; // required
  public java.util.Map<Integer,Integer> mymap; // required
  ...
  public MyStruct(
    ...
    java.util.Set<Integer> myset,
    java.util.Map<Integer,Integer> mymap)
  {
    this();
    this.mybool = mybool;
    setMyboolIsSet(true);
  ...
  public MyStruct(MyStruct other) {
    ...
    if (other.isSetMylist()) {
      java.util.List<Integer> __this__mylist = new java.util.ArrayList<Integer>(other.mylist);
      this.mylist = __this__mylist;
    }
    if (other.isSetMyset()) {
      java.util.Set<Integer> __this__myset = new java.util.HashSet<Integer>(other.myset);
      this.myset = __this__myset;
    }
    if (other.isSetMymap()) {
      java.util.Map<Integer,Integer> __this__mymap = new java.util.HashMap<Integer,Integer>(other.mymap);
  ...
  public void unsetMybool() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MYBOOL_ISSET_ID);
  }

  /** Returns true if field mybool is set (has been assigned a value) and false otherwise */
  public boolean isSetMybool() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MYBOOL_ISSET_ID);
  }

  public void setMyboolIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MYBOOL_ISSET_ID, value);
  }
  ...
  public void unsetMybyte() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MYBYTE_ISSET_ID);
  }

  /** Returns true if field mybyte is set (has been assigned a value) and false otherwise */
  public boolean isSetMybyte() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MYBYTE_ISSET_ID);
  }

  public void setMybyteIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MYBYTE_ISSET_ID, value);
  }
  ...
  public void unsetMyi16() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MYI16_ISSET_ID);
  }

  /** Returns true if field myi16 is set (has been assigned a value) and false otherwise */
  public boolean isSetMyi16() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MYI16_ISSET_ID);
  }

  public void setMyi16IsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MYI16_ISSET_ID, value);
  }
  ...
  public void unsetMyi32() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MYI32_ISSET_ID);
  }

  /** Returns true if field myi32 is set (has been assigned a value) and false otherwise */
  public boolean isSetMyi32() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MYI32_ISSET_ID);
  }

  public void setMyi32IsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MYI32_ISSET_ID, value);
  }
  ...
  public void unsetMyi64() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MYI64_ISSET_ID);
  }

  /** Returns true if field myi64 is set (has been assigned a value) and false otherwise */
  public boolean isSetMyi64() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MYI64_ISSET_ID);
  }

  public void setMyi64IsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MYI64_ISSET_ID, value);
  }
  ...
  public void unsetMydouble() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MYDOUBLE_ISSET_ID);
  }

  /** Returns true if field mydouble is set (has been assigned a value) and false otherwise */
  public boolean isSetMydouble() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MYDOUBLE_ISSET_ID);
  }

  public void setMydoubleIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MYDOUBLE_ISSET_ID, value);
  }
  ...
  public void addToMylist(int elem) {
    if (this.mylist == null) {
      this.mylist = new java.util.ArrayList<Integer>();
    }
    this.mylist.add(elem);
  }

  public java.util.List<Integer> getMylist() {
    return this.mylist;
  }

  public MyStruct setMylist(java.util.List<Integer> mylist) {
    this.mylist = mylist;
    return this;
  }
  ...
  public void addToMyset(int elem) {
    if (this.myset == null) {
      this.myset = new java.util.HashSet<Integer>();
    }
    this.myset.add(elem);
  }

  public java.util.Set<Integer> getMyset() {
    return this.myset;
  }

  public MyStruct setMyset(java.util.Set<Integer> myset) {
    this.myset = myset;
    return this;
  }
  ...
  public void putToMymap(int key, int val) {
    if (this.mymap == null) {
      this.mymap = new java.util.HashMap<Integer,Integer>();
    }
    this.mymap.put(key, val);
  }

  public java.util.Map<Integer,Integer> getMymap() {
    return this.mymap;
  }

  public MyStruct setMymap(java.util.Map<Integer,Integer> mymap) {
    this.mymap = mymap;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case MYLIST:
      if (value == null) {
        ...
        setMylist((java.util.List<Integer>)value);
      }
      break;
    ...
    case MYSET:
      if (value == null) {
        ...
        setMyset((java.util.Set<Integer>)value);
      }
      break;
    ...
    case MYMAP:
      if (value == null) {
        ...
        setMymap((java.util.Map<Integer,Integer>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((mybool) ? 131071 : 524287);

    hashCode = hashCode * 8191 + (int) (mybyte);

    hashCode = hashCode * 8191 + myi16;

    hashCode = hashCode * 8191 + myi32;

    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(myi64);

    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(mydouble);

    hashCode = hashCode * 8191 + ((isSetMystring()) ? 131071 : 524287);
    if (isSetMystring())
      hashCode = hashCode * 8191 + mystring.hashCode();

    hashCode = hashCode * 8191 + ((isSetMylist()) ? 131071 : 524287);
    if (isSetMylist())
      hashCode = hashCode * 8191 + mylist.hashCode();

    hashCode = hashCode * 8191 + ((isSetMyset()) ? 131071 : 524287);
    if (isSetMyset())
      hashCode = hashCode * 8191 + myset.hashCode();
  ...
  private static class MyStructStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MyStructStandardScheme getScheme() {
      return new MyStructStandardScheme();
    }
  }

  private static class MyStructStandardScheme extends org.apache.thrift.scheme.StandardScheme<MyStruct> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mylist = new java.util.ArrayList<Integer>(_list0.size);
                int _elem1;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.myset = new java.util.HashSet<Integer>(2*_set3.size);
                int _elem4;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.mymap = new java.util.HashMap<Integer,Integer>(2*_map6.size);
                int _key7;
                int _val8;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MyStruct struct) throws org.apache.thrift.TException {
      ...
      if (struct.mymap != null) {
        oprot.writeFieldBegin(MYMAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<Integer, Integer> _iter12 : struct.mymap.entrySet())
          {
  ...
  private static class MyStructTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MyStructTupleScheme getScheme() {
      return new MyStructTupleScheme();
    }
  }

  private static class MyStructTupleScheme extends org.apache.thrift.scheme.TupleScheme<MyStruct> {
      ...
      if (struct.isSetMymap()) {
        {
          ...
          for (java.util.Map.Entry<Integer, Integer> _iter15 : struct.mymap.entrySet())
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.mylist = new java.util.ArrayList<Integer>(_list16.size);
          int _elem17;
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.myset = new java.util.HashSet<Integer>(2*_set19.size);
          int _elem20;
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.mymap = new java.util.HashMap<Integer,Integer>(2*_map22.size);
          int _key23;
          int _val24;
